 ...
 *
 * First, place all the keywords in an array of 20 elements, then place all the
 * excuses in another array of 20 elements too. Then, uppercase all the keywords
 * and excuses then put it to another array. Why? because it simplifies this
 * problem.
 *
 * Then you set an array (size 20) of integer, to count how many keywords are
 * there in each excuses. Use POS (substr,string) to find out if the keyword is
 * in the excuse.
 *
 * After that, do a looping to search which one contains the most keyword, and
 * display it.
 *
 * Problem Link:
