 ...
 *
 * Brute force... only maximum 8 codes, each code only have at max 10 bits...
 * try all nC2 (n Choose 2) possible pairings and check whether bit i and bit j
 * is a prefix of each other... total brute force...
 *
 * Problem Link:
